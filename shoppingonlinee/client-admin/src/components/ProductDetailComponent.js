        ...
        <form>
          <table>
            <tbody>
              ...
              <tr>
                <td>Giá</td>
                <td><input type="text,number" value={this.state.txtPrice} onChange={(e) => { this.setState({ txtPrice: e.target.value}) }} /></td>
              </tr>
              <tr>
                <td>Hình ảnh</td>
              ...
              <tr>
                <td></td>
                <td>
                  <button className='nuttt' type="submit" value="ADD NEW" onClick={(e) => this.btnAddClick(e)}>Thêm</button>
                  <button className='nuttt' type="submit" value="UPDATE" onClick={(e) => this.btnUpdateClick(e)}>Cập nhật</button>
                  <button className='nuttt' type="submit" value="DELETE" onClick={(e) => this.btnDeleteClick(e)}>Xoá</button>
                </td>
              </tr>
              <tr>
